...
public class BottomSheet extends Dialog implements DialogInterface {
    ...
    public String FONT_MontserratSemiBold = "Montserrat-SemiBold.otf";
    ...
    private void init(final Context context) {
        ...
        BaseAdapter baseAdapter = new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                holder.title.setTypeface(getFontMontserratSemiBold(getContext()));
    ...
    public static Typeface getTypeFace(Context context, String fileName) {
        ...
        if (tempTypeface == null) {
            tempTypeface = Typeface.createFromAsset(context.getAssets(), "fonts/" + fileName);
            sTypeFaces.put(fileName, tempTypeface);
        }

        return tempTypeface;
    }
    public Typeface getFontMontserratSemiBold(Context context) {
        Typeface cFonts = getTypeFace(context, FONT_MontserratSemiBold);
        return cFonts == null ? Typeface.DEFAULT : cFonts;
    }
}
